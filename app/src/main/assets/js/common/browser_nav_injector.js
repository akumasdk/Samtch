    ...
    function inject() {
        ...
        if (!loggedIn) {
            if (!document.getElementById(LOGIN_BTN_ID)) {
                ...
                loginBtn.style.cssText = 'margin-left: auto; margin-right: 8px; background: #9147ff; color: white; border: none; padding: 0 20px; height: 34px; font-size: 14px; font-weight: 700; border-radius: 17px; cursor: pointer; flex-shrink: 0;';
                loginBtn.onclick = () => {
        ...
        if (!settingsBtn) {
            ...
            settingsBtn.style.cssText = 'margin-right: 18px; background: transparent; border: none; padding: 0; display: inline-flex; align-items: center; justify-content: center; cursor: pointer; width: 34px; height: 34px; border-radius: 8px; flex-shrink: 0;';
